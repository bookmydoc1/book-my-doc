...
const SubscriptionSection = ({ title }) => {
  const plan1 = {
    name: "Lifetime Free Subscription",
    features: [
    ...
    <ContainerSection>
      ...
      <div className='mt-10 grid grid-cols-2 gap-4'>
        <div className='relative bg-primary/[.1] rounded-2xl text-center pb-10'>
          <div className='w-[45%] absolute -top-[1px] left-[50%] -translate-x-[50%] bg-white rounded-b-2xl flex items-center justify-center text-2xl font-medium p-4'>
            Free Subscription
          </div>
          <img className='m-auto mt-28 h-28' src="/images/subscription-cards/img1.svg" alt="img" />
          <h3 className='text-2xl my-4 font-medium'>{plan1.name}</h3>
          {
            plan1.features.map((feature, index) => (
              <div>
                <p>{feature}</p>
                <div className={`flex items-center gap-10 px-12 my-4 ${plan1.features.length === index+1 && 'hidden'}`}>
        ...
        <div className='relative bg-white border border-primary/[.1] rounded-2xl text-center'>
          <div className='w-[45%] absolute -top-[1px] left-[50%] -translate-x-[50%] bg-white border border-primary/[.1] border-t-0 rounded-b-2xl flex items-center justify-center text-2xl font-medium p-4'>
            Paid Version
          </div>
          <img className='m-auto mt-28 h-28' src="/images/subscription-cards/img2.svg" alt="img" />
          <h3 className='text-2xl my-4 font-medium'>{plan2.name}</h3>
          {
